...
var whatfreewords_1 = __importDefault(require("./whatfreewords")); // eslint-disable-line
var pluscodes_1 = __importDefault(require("./pluscodes")); // eslint-disable-line
var valid = {
    ...
    if (selected.name === 'latlng') {
        ...
        for (var col = 0; col < header.length; col += 1) {
            ...
            for (var row = 0; row < arr.length; row += 1) {
                ...
                if (valid.isValidPluscode(val)) {
                    ...
                    var decoded = pluscodes_1.default.decode(val);
        ...
        for (var col = 0; col < header.length; col += 1) {
            ...
            for (var row = 0; row < arr.length; row += 1) {
                ...
                if (valid.isValidWhatFreeWords(val)) {
                    validatedRows.push(arr[row]);
                    var decoded = whatfreewords_1.default.words2latlon(val);
...
var usedRanges = 'random_points_25!A1:J27';
var selected1 = 'random_points_25!D:D';
var selected2 = 'random_points_25!12:12';
var selected3 = 'random_points_25!E31,random_points_25!14:14,random_points_25!15:15,random_points_25!19:19';
...
exports.default = arrayToGeojson;
