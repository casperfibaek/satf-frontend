(function () {
    ...
    function htmlTable(obj) {
      ...
      if (obj._data) {
        for (var i = 0; i < obj._data.length; i += 1) {
          table += "<tr><td>".concat(obj._data[i], "</td></tr>");
        }
      } else {
        ...
        for (var _i = 0; _i < keys.length; _i += 1) {
          var key = keys[_i];
          var val = obj[key];
          table += "<tr><td>".concat(key, "</td><td>").concat(val, "</td></tr>");
        }
      }
    ...
    Office.onReady().then(function () {
      ...
      function onMapClick(e) {
        ...
        idbKeyval.get('hello').then(function (val) {
