function findUnique(arrOfObjects) {
    const found = [];
...
export default function geojsonToArray(geojson, layername = false) {
    let cells = [];
    ...
    if (geojson.type === 'FeatureCollection') {
        ...
        const latlngs = geojson.features.map((e) => e.geometry.coordinates);
...
//# sourceMappingURL=geojson_to_array.js.map